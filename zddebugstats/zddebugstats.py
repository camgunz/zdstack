...
# URL Structure
# BASEURL/
#   {'action': self.get_status, 'kwargs': {'zserv_name': 'blahblahblah'}}
# BASEURL/{zserv_name}/
#   {'action': self.get_team, 'kwargs': 

###
# ZDStack Info RPC Methods
#
# self.get_status
# self.get_logfile

###
# ZServ Info RPC Methods
#
# self.get_zserv
# self.get_all_zservs
# self.list_zserv_names
# self.get_zserv_config
# self.get_remembered_stats
# self.get_all_remembered_stats
